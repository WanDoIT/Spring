					...
					<ul class="app_list">
                        <li class="clear">
                            ...
                            <div class="app_content email_area">
                                <input type="text" id="datepicker_a" placeholder="날짜를 선택하세요" name="tripdate" required="required"></p>
                            </div>
						</li>
						...
						<li class="clear">
							...
							<div class="app_content"><input type="text" class="w100p" id="name_lbl" placeholder="제목을 입력하세요" name="title" required="required"/></div>
						</li>
...
전화 상담 희망시 기재 부탁드립니다." name="content" required="required"></textarea></div>
						</li>
					</ul>
					<p class="btn_line">
